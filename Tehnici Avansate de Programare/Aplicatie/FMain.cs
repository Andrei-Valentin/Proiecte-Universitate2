...
namespace AplicatieGestiune
{
    public partial class FMain : Form
    {
        ...
        string Selectie;
        public FMain(string Utilizator)
        {
            InitializeComponent();
        ...
        {
            //Mutam bara laterala care indica optiunea selectata
            Mutare_Selectie(btn_Clienti);

            Afisare_butoane();
        }

        private void btn_Servicii_Click(object sender, EventArgs e)
        {
            //Mutam bara laterala care indica optiunea selectata
            Mutare_Selectie(btn_Servicii);

            Afisare_butoane();
        }

        private void btn_Istoric_Click(object sender, EventArgs e)
        {
            //Mutam bara laterala care indica optiunea selectata
            Mutare_Selectie(btn_Istoric);
        ...
        private void btn_Gestionare_Click(object sender, EventArgs e)
        {
            ...
            if (Selectie == btn_Clienti.Name)
            {
                Clienti Fereastra = new Clienti();
                Fereastra.ShowDialog();
            }

            if (Selectie == btn_Servicii.Name)
            {
                ServiciiActive Fereastra = new ServiciiActive();
                Fereastra.ShowDialog();
            }

            if (Selectie == btn_Istoric.Name)
            {
                IstoricServicii Fereastra = new IstoricServicii();
                Fereastra.ShowDialog();
            }
